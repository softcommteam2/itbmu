            ...
            <p class="nospace">
             ...
             <div style="width:110px; height:130px;"><img id="blah" src="#" alt="your image" style="width:110px; height:130px;"/></div><br><input type="file" name="photo" id="photo"  size="30" required onchange="readURL(this);">
                ...
                <option value="2010">2010</option><option value="2011">2011</option><option value="2012">2012</option><option value="2013">2013</option><option value="2014">2014</option><option value="2015">2015</option><option value="2016">2016</option><option value="2017">2017</option><option value="2018">2018</option><option value="2019">2019</option><option value="2020">2020</option><option value="2021">2021</option>              </select> -->
                                <!-- ######### -->
                                <!-- <input type="text" name="aqy" id="aqy" size="30" required> -->
                                <!-- ######### -->
                            </td>
                        </tr>
                        <tr height="50" valign="middle">
                  ...
                  <option value="Lady">Lady</option>
                                ...
                                <!-- <input type="checkbox" name="status" id="status" required>&nbsp;I affirm that all above-mentioned statements made by me on this form are correct. I
understand that any inaccurate statement will reader my application invalid. I promise to abide by
the rules and regulations laid by the University and the Government of the Union of Myanmar. -->
                            </td>
                        </tr>
                        <tr height="50">
                            <td>&nbsp;</td>
                            <td><input type="submit" name="save" value="Save" onclick="return checknull()" style="display: inline-block;
    width: auto;
    min-width: 150px;
    margin: 0;
    padding: 8px 5px;
    cursor: pointer;"></td>
                        ...
                        <tr height="50">
                            <td>&nbsp;</td>
                            <td><input type="reset" name="cancel" value="Cancel" style="display: inline-block;
    width: auto;
    min-width: 150px;
    margin: 0;
    padding: 8px 5px;
