            ...
            <div class="pt-8 space-y-6 sm:pt-10 sm:space-y-5">
                ...
                <div class="p-3 space-y-6 border sm:space-y-5">
                    ...
                    <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:pt-5">
                        ...
                        <div class="mt-1 sm:mt-0 sm:col-span-2">
                        <input type="text" name="news" id="news" autocomplete="given-name" class="block w-full max-w-lg rounded-md shadow-sm focus:ring-yellow-300 focus:border-yellow-300 sm:max-w-xs sm:text-sm" value="{{ old('news')?? $lecture->news }}">
                        </div>
                    </div>
                </div>
            </div>
