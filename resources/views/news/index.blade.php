...
{{-- <div class="container mx-auto mt-5">
    ...
    <div class="flex justify-between">
        ...
        <a href="{{url('/news/create')}}" class="inline-flex items-center px-4 py-2 text-sm font-medium text-white bg-indigo-600 border border-transparent rounded-md shadow-sm button hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
            Add News
        </a>
